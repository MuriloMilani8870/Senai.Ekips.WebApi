        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Cargos>(entity =>
            {
                ...
                entity.HasIndex(e => e.NomeCargo)
                    .HasName("UQ__Cargos__4D9FD7DE9BDF812F")
                    .IsUnique();
            ...
            modelBuilder.Entity<Departamentos>(entity =>
            {
                ...
                entity.HasIndex(e => e.NomeDepartamento)
                    .HasName("UQ__Departam__06E40A00C61A3D5D")
                    .IsUnique();
            ...
            modelBuilder.Entity<Funcionarios>(entity =>
            {
                ...
                entity.HasIndex(e => e.Cpf)
                    .HasName("UQ__Funciona__C1F8973123C87897")
                    .IsUnique();

                entity.HasIndex(e => e.Nome)
                    .HasName("UQ__Funciona__7D8FE3B2B264A1C0")
                    .IsUnique();
            ...
            modelBuilder.Entity<Usuarios>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__Usuarios__A9D105341CA84886")
                    .IsUnique();
